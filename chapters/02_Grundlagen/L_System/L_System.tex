...
Ohne Erweiterungen entstehen hierbei immer zusammenhängende Strukturen bei dem die turtle nicht springen kann.
...
Die turtle kann sich also nur fortbewegen ohne zu zeichnen, indem sie an eine vorherige Position zurückspringt.
...
Hier gibt es für das Nicht-Terminal $F$ drei Produktionen, zwei Produktionen mit einer Wahrscheinlichkeit von \SI{33}{\percent} gewählt und eine Produktion mit \SI{34}{\percent}.

...
\end{table}
\todo{Auf Variablennamen eingehen? Oder ist die Bedeutung mithilfe des vorhergehenden Textes offensichtlich?}
...
\paragraph{Anpassung an neroRL} \label{neroAnpassungKonzept}
